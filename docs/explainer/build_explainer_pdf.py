...
Brand basis: /Users/vladimir/projects/pseudo/docs/style/branding.md
             + /Users/vladimir/projects/pseudo/docs/press-kit/brand-kit/
                 brand-guidelines.html (the canonical reference render).
...
def build():
    ...
    foot_row = Table(
        [
            [
                Paragraph(
                    "ALEXANDER FORD<br/>"
                    '<font color="#555E78" size="9">ALEXANDER FORD VENTURES · MIT</font>',
                    styles["footer_l"],
                ),
                Paragraph(
                    "GITHUB.COM/ALEXANDER-FORD-VENTURES/<br/>"
    ...
    story.append(
        Paragraph(
            '<font name="GeistMono-Bold" color="#0A0A0A">GITHUB.COM/ALEXANDER-FORD-VENTURES/PROJECT-ARCHITECT</font> &nbsp;&nbsp;·&nbsp;&nbsp; '
