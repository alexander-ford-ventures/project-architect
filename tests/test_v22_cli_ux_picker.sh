...
# Routing logic
assert_contains "$CONTENT" 'cli_experience_model' 'must reference cli_experience_model gate'
assert_contains "$CONTENT" 'tech_stack.language' 'routing must condition on tech_stack.language'
