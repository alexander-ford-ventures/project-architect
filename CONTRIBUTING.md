...
Use the [feature request issue template](.github/ISSUE_TEMPLATE/feature_request.yml) or open a [Discussion](https://github.com/siliconyouth/project-architect/discussions) for open-ended ideas.
